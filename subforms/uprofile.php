...
if($_REQUEST['ftype']=='Add')
{
    ...
    {
        $query="insert into uprofile(name,email,phone,password,updby,promocode,allprofiles)
        values('".addslashes($_REQUEST['name'])."','".$_REQUEST['email']."','".$_REQUEST['mobile']."','".base64_encode($_REQUEST['rpassword'])."','".$_SERVER['REMOTE_ADDR']."','".$_REQUEST['promocode']."','".$_REQUEST['ex-all-profiles']."')";
