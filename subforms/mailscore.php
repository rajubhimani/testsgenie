...
$strSubject='TestsGenie TestPaper Result' ;
$message = '
...
<div>
    <table style="width:100%;table-layout:fixed;">
        <tr>
            ...
            <img src="https://dlwhosting.com/testsgenie-mail-logo/logo.png" style="max-width:120px; margin:20px 0" />
            </td>
            <td>
...
<div style="margin-top:30px;">
    <div style="background:#202a6b;border-radius:5px;padding:15px;text-align:center;color:#fff;font-size:12px;">
        <div>To know more about TestsGenie <a href="https://testsgenie.com" style="color:#fff">Click Here</a></div>
        ...
        <div class="social-icon-fa">
            <a href="https://www.facebook.com/Tests-Genie-113290281019557" style="display:inline-block;vertical-align:middle;margin-right:5px;"><img src="https://dlwhosting.com/testsgenie-mail-logo/sicons/fc1.png" style="max-height:25px"/></a>
            <a href="https://www.instagram.com/testsgenie/" style="display:inline-block;vertical-align:middle;margin-right:5px;"><img src="https://dlwhosting.com/testsgenie-mail-logo/sicons/fc2.png" style="max-height:25px"/></a>
            <a href="https://twitter.com/TestsGenie" style="display:inline-block;vertical-align:middle;margin-right:5px;"><img src="https://dlwhosting.com/testsgenie-mail-logo/sicons/fc3.png" style="max-height:25px"/></a>
            <a href="https://www.linkedin.com/company/testsgenie" style="display:inline-block;vertical-align:middle;"><img src="https://dlwhosting.com/testsgenie-mail-logo/sicons/fc4.png" style="max-height:25px"/></a>
        </div>
    </div>
</div>
';
...
$_SESSION['msgText']='Mail has been successfully sent';
if($_REQUEST['rdpage']!='')
{
  header('location:../user-dashboard/'.$_REQUEST['rdpage'].'?utpid='.$_REQUEST['rdid'].'');
}
else
{
